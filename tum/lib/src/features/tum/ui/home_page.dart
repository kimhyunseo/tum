...
class _HomePageState extends ConsumerState<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color(0xFFF8FAF8), // Very light grey-green background
      appBar: AppBar(
      ...
      body: RefreshIndicator(
        onRefresh: () async => ref.refresh(purchaseRecordProvider),
        child: ListView(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () {}, 
                  child: const Text('전체보기', style: TextStyle(color: Color(0xFF2E7D32)))),
              ],
            ),
  ...
  double _calculateSaved(List<PurchaseRecord> records) {
    return records
  ...
  Widget _thinkingItemCard(BuildContext context, PurchaseRecord r) {
